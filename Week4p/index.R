...
## The sf object that we pass to leaflet() needs to 
## have a geographic coordinate reference system (CRS) 
## indicating latitude and longitude (EPSG code 4326).
## Here, we use the st_transform() 
## function of sf to transform the data d which has CRS given by EPSG code 4267 to CRS with EPSG code 4326.
st_crs(d)$epsg
